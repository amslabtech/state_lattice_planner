...
bool load_lookup_table(const std::string& lookup_table_file_name,
                       LookupTable& lookup_table)
{
  lookup_table.clear();
  std::cout << "loading lookup table from " << lookup_table_file_name
            << std::endl;
...
void get_optimized_param_from_lookup_table(
    ...
    const double v0, const double k0,
