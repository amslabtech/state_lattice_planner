 ...
 * @author AMSL
 */
#ifndef TRAJECTORY_GENERATOR_TRAJECTORY_GENERATOR_DIFF_DRIVE_H
#define TRAJECTORY_GENERATOR_TRAJECTORY_GENERATOR_DIFF_DRIVE_H
...
public:
   ...
   */
  double
  generate_optimized_trajectory(const Eigen::Vector3d&,
                                const MotionModelDiffDrive::ControlParams&,
   ...
   */
  void get_jacobian(const double, const MotionModelDiffDrive::ControlParams&,
                    const Eigen::Vector3d&, Eigen::Matrix3d&);
  /**
   ...
   * @param[out] dp
   */
  void calculate_scale_factor(double, double, const Eigen::Vector3d&,
                              Eigen::Vector3d&,
                              MotionModelDiffDrive::ControlParams&,
                              MotionModelDiffDrive::Trajectory&,
                              Eigen::Vector3d&);
...
#endif  // TRAJECTORY_GENERATOR_TRAJECTORY_GENERATOR_DIFF_DRIVE_H
